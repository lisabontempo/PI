...
public class MainActivity extends AppCompatActivity{
        ...
        ok.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view)
            {
                if((edtIdade.getText().toString().equals("0"))||(edtIdade.getText().toString().equals("1"))||
                    ...
                    Toast.makeText(getApplicationContext(), "Idade não permitida!", Toast.LENGTH_LONG).show();}
        });
                }
    ...
    public void ProximaTela(String idade){
        if (idade.equals("0"))
        {   Intent intent0 = new Intent(getApplicationContext(), ZeroAnosActivity.class);
            startActivity(intent0);}
        if (idade.equals("1"))
        {   Intent intent0 = new Intent(getApplicationContext(), UmAnoActivity.class);
            startActivity(intent0);}
        if (idade.equals("2"))
        {   Intent intent0 = new Intent(getApplicationContext(), DoisAnosActivity.class);
            startActivity(intent0);}
            }
